...
Video games simulate _being_ (e.g. character controls, collision detection, [skins](https://namemc.com/minecraft-skins/random)) and _sensation_ (sight and sounds).
...
Science Fiction novels and films often employ artificially intelligent machines.
More recently, Chat Bots have become very impressive, holding meaningful conversations in a flexible way.
...
and yet NPC has become a synonym for someone who does not think for themselves.
