...
However, those claiming Artificial General Intelligence is within reach
should consider the current state of NPCs.
Nowadays, the word NPC is an insult for someone who [does not think for themselves](https://en.wikipedia.org/wiki/NPC_(meme)),
and popular films [assume their predictability](https://en.wikipedia.org/wiki/Jumanji:_Welcome_to_the_Jungle).
Amidst this noise we should remember that Turing's test was a party game.
