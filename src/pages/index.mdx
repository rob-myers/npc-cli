...
Almost 75 years later we have a multi-billion dollar <SideNote>An estimated 350 billion dollars revenue in 2022.</SideNote> video game industry,
...
Our first step is to recognise the problem is _too hard_.
At least, it's too hard to solve within the confines of game development cycles.
...
Then let's make the problem a bit easier.
Instead of setting an incredibly intricate clockwork world in motion,
