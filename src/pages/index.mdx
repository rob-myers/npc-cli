...
The underlying problem asks for NPCs which are indistinguishable from humans, relative to the game environment.
Individual NPCs needn't be particularly intelligent (e.g. multiple choice dialogue), but they must collectively interact just like humans would.
...
Recently there's been a revolution in machines with human behaviour.
