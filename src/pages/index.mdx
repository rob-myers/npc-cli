...
Artificially intelligent machines are a popular topic in novels and films.
Outside literature and entertainment, Chat Bots have started to become very impressive, holding meaningful conversations in a flexible way.
...
Virtual worlds avoid a multitude of difficult real world sensor/effector based problems,
yet NPC has become a synonym for someone who does not think for themselves.
We should remember that Turing's test was actually a party game where a computer had to pretend to be a woman.
