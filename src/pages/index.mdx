...
The underlying problem asks for NPCs which act like humans, relative to the game environment.
...
Concerning machines with human behaviour, we must mention the recent revolution in Chat Bots.
Amazingly, they can now hold flexible and meaningful conversations <SideNote>Putting aside their hallucinations and somewhat memoryless nature.</SideNote>.
