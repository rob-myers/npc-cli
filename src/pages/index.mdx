...
we should consider the current state of NPCs.
...
Almost 75 years later we have a multi-billion dollar video game industry (hundreds of billions),
and a distinct lack of flexible or believable NPCs.
This problem is our underlying motivation.

<Card> 
**Background Problem**. [_Turing test for video games_]

Develop Non-Player Characters which are indistinguishable from Players.
<SideNote width={400}>This is relative to the video game's UI e.g. multiple choice dialog.</SideNote>
</Card>

🚧 WIP

The above problem is extremely difficult.
It's not even clear where to begin.
...
The problem described above is way _too hard_. */}
