...
Yes, it's amazing Chat Bots can now hold flexible and meaningful conversations <SideNote>Putting aside their hallucinations and somewhat memoryless nature.</SideNote>.
But before claiming Artificial General Intelligence is within reach,
...
Popular films depict them as conversationally [rigid and predictable](https://en.wikipedia.org/wiki/Jumanji:_Welcome_to_the_Jungle), usually with a single linear conversation.
In our search for intelligent machines, we should remember that Turing's test was a _party game_.
Almost 75 years later, we have (i) a multi-billion dollar video game industry,
(ii) a distinct lack of malleable and believable NPCs.
