...
> to work towards believable NPCs <SideNote>_NPC_ stands for "Non-Player Character" i.e. a video game character not controlled by the Player.</SideNote> by building flexible real-time control systems.
