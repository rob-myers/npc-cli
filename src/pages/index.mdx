...
> 2. Enable a single human "Game Master" to be indistinguishable from many human Players.

A Non-Player Character (NPC) in a video game is anything representing _another_ living organism, robot, or supernatural being.
Video games simulate _embodiment_ (e.g. collision detection and character controls) and _sensation_ (sight and sounds).
You can _be_ something, and your sensory input and possible actions reflect your geographic position and narrative state.
But it's not much fun being something unless there are _other beings_.
