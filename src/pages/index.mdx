...
Amazingly, Chat Bots can now hold meaningful conversations in a flexible way <SideNote>Putting aside hallucinations and their somewhat memoryless nature.</SideNote>.
...
Despite the absence of difficult sensor/effector engineering problems,
NPC has become a synonym for someone who does not think for themselves.
We should remember that Turing's test was actually a party game.
Here we are almost 75 years later with a multi-billion dollar video game industry,
where malleable and believable characters are in very short supply.
