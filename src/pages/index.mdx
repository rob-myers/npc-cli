...
Video games simulate _incarnation_ (e.g. character controls, [skins](https://namemc.com/minecraft-skins/random), collision detection) and _sensation_ (sight and sounds).
