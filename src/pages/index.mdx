...
Before clarifying our objectives, some background is in order.
...
But those claiming Artificial General Intelligence is within reach
...
Popular films depict them as conversationally [rigid](https://en.wikipedia.org/wiki/Jumanji:_Welcome_to_the_Jungle) and [predictable](https://en.wikipedia.org/wiki/Jumanji:_The_Next_Level), usually with a single linear conversation (and they're not wrong).
Concerning intelligent machines, we should remember that Turing's test was actually a party game.
