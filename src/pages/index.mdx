...
This website is driven by a difficult problem. 

<Card> 
**Underlying Problem**

In a video game with a sufficiently rich environment,
develop NPCs <SideNote>NPC stands for "Non-Player Character" i.e. a video game character not controlled by a (human) Player.</SideNote> which are indistinguishable from Players.
...
Yes, we're talking about video games.
...
Why has progress not been made towards the underlying problem?
...
Then instead of tackling this problem head on, we'll work towards an intermediate solution.
