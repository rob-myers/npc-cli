...
It's amazing Chat Bots can now hold flexible and meaningful conversations <SideNote>Putting aside their hallucinations and somewhat memoryless nature.</SideNote>.
...
Popular films depict them as conversationally [rigid and predictable](https://en.wikipedia.org/wiki/Jumanji:_Welcome_to_the_Jungle),
usually with a single linear conversation.
...
and a distinct lack of flexible/believable NPCs.
