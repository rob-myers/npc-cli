...
- 🚧 create decor spritesheet
  ...
  - generated by `assets.js`, `changedFiles` sensitive
  - basic door image: dimensions of door (door width?)
    - hull door `100 * worldScale` i.e. `2.5m`
    - non-hull door `220/5 * worldScale` i.e. `1.1m`
  - basic wall image: black with horizontal grey borders
